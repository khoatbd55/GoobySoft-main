...
#include "Windows/Dialogs/AnalyzeDialogs/J1939EngineSimulatorDialog/J1939EngineSimulatorDialog.h"
#include <stdio.h>
...
int main(int, char**)
{
    ...
    SDL_Window* window = SDL_CreateWindow("GoobySoft", 1000, 600, window_flags);
    if (window == nullptr)
    {
...
#endif
    {
        ...
        Windows_Dialogs_AnalyzeDialogs_J1939EngineSimulatorDialog_update();

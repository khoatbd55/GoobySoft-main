...
bool j1939EngineSimulatorDialog = false;
	...
	if (ImGui::BeginMainMenuBar()) {
		...
		if (ImGui::BeginMenu("Analyze")) {
			if (ImGui::BeginMenu("CAN <---> USB module")) {
				...
				ImGui::MenuItem("J1939 Engine Simulator", nullptr, &j1939EngineSimulatorDialog);
				ImGui::EndMenu();
			}
			ImGui::EndMenu();
		}
		...
		if (j1939EngineSimulatorDialog) {
			Windows_Dialogs_AnalyzeDialogs_J1939EngineSimulatorDialog_showJ1939EngineSimulatorDialog(&j1939EngineSimulatorDialog);
		}
